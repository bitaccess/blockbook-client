...
export const NormalizedTxBitcoinVin = t.union(
  [NormalizedTxBitcoinVinWithoutCoinbase, NormalizedTxBitcoinVinWithCoinbase],
...
export const AddressDetailsBitcoinTxids = paginated(
  extendCodec(
...
export const AddressDetailsBitcoinTxs = paginated(
  extendCodec(
    AddressDetailsBitcoinTokenBalances,
    {},
    {
...
export const XpubDetailsTxids = paginated(
  extendCodec(
    XpubDetailsTokenBalances,
    {},
    {
...
export const XpubDetailsTxs = paginated(
  extendCodec(
    XpubDetailsTokenBalances,
    {},
    {
